...
role_files = [
    C.PROJECT / "output/cdcode/cdcode_protein_roles.json",
    C.PROJECT / "v2.0/output/cdcode/cdcode_addition_driver_annotations.json",
    C.PROJECT / "output/cdcode/cdcode_roles_detail.json",
]
role_map = {}
for f in role_files:
